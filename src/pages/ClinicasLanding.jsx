...
CIERRE SIEMPRE CON:
Recuerda invitar a rellenar el formulario de consulta gratuita en la web.`;
  ...
  '@graph': [
    {
      ...
      hasOfferCatalog: {
        '@type': 'OfferCatalog',
        name: 'Planes de marketing dental',
        itemListElement: [
          {
            '@type': 'Offer',
            name: 'Web + Mantenimiento',
    ...
    },
    {
      ...
      mainEntity: [
        {
          '@type': 'Question',
          name: '¿Cuánto tarda en estar lista la web de mi clínica?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Una web dental completa tarda entre 2 y 3 semanas. Si además incluimos el setup de SEO local y la IA, sumamos 1 semana más. Siempre te damos una fecha de entrega confirmada al inicio.',
          },
        },
        {
          '@type': 'Question',
          name: '¿En cuánto tiempo veo resultados en Google?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'El SEO local suele dar resultados visibles en 30-90 días. Google My Business optimizado puede dar resultados en 2-4 semanas. Depende de la competencia en tu zona, pero siempre vemos mejora.',
          },
        },
        {
          '@type': 'Question',
          name: '¿Cómo funciona la IA para reservar citas?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Instalamos un asistente de IA en tu web que conversa con los pacientes, responde sus preguntas sobre precios y tratamientos, y les ayuda a reservar cita. Se sincroniza con tu agenda y envía confirmaciones automáticas.',
          },
        },
        {
          '@type': 'Question',
          name: '¿Necesito saber programar para gestionar la web?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'No. Te entregamos la web con un panel de administración sencillo donde puedes editar textos, añadir fotos y gestionar el blog sin saber programación. También te hacemos una formación en videollamada.',
          },
        },
        {
          '@type': 'Question',
          name: '¿La IA habla con pacientes en otros idiomas?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Sí. Nuestro asistente de IA detecta automáticamente el idioma del paciente y responde en consecuencia. Ideal para clínicas en zonas turísticas o con pacientes internacionales.',
          },
        },
        {
          '@type': 'Question',
          name: '¿Qué pasa si tengo dudas después del lanzamiento?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Todos los planes incluyen soporte después del lanzamiento. Puedes contactarnos por WhatsApp o email y te respondemos en menos de 24h. Los planes Pro e IA 360° incluyen mantenimiento mensual incluido.',
          },
        },
      ],
    },
...
export default function ClinicasLanding() {
  ...
  const openForm = (e) => { e && e.preventDefault(); navigate('/clinicas-dentales/consulta'); };
  ...
  useEffect(() => {
    ...
    // Helper: upsert a <link> by rel+specific attr
    const setLink = (rel, attr, val) => {
    ...
    setMeta('name', 'keywords', 'diseño web clínicas dentales, marketing dental España, web para dentistas precio, agencia marketing dental Barcelona, diseño web dentistas, SEO dental');
    ...
    setMeta('property', 'og:site_name', 'AgutiDesigns');
    ...
    setMeta('property', 'og:image:alt', 'AgutiDesigns — Diseño Web para Clínicas Dentales en España');
    ...
    setMeta('name', 'twitter:image:alt', 'AgutiDesigns — Diseño Web para Clínicas Dentales en España');

    // Inject JSON-LD schema
    const existingSchema = document.getElementById('clinicas-schema');
    if (!existingSchema) {
      const script = document.createElement('script');
      script.id = 'clinicas-schema';
      script.type = 'application/ld+json';
      script.textContent = JSON.stringify(PAGE_SCHEMA);
      document.head.appendChild(script);
    }

    // Cleanup: restore defaults when leaving this page
    return () => {
      document.title = 'Agutidesigns | Diseño Web Profesional · Barcelona';
      setMeta('name', 'description', 'Agutidesigns — agencia de diseño web profesional en Barcelona. Páginas web a medida para negocios y clínicas dentales que quieren crecer. Sin plantillas, solo resultados.');
      const schemaEl = document.getElementById('clinicas-schema');
    ...
    <div className="cl-landing">
      ...
      <Navbar
        ...
        cta={{
          ...
          href: '/clinicas-dentales/consulta',
          onClick: openForm,
        ...
        <div className="container cl-hero__container">
          ...
          >
            ...
            <motion.h1 variants={fadeUp} className="cl-hero__h1">
              Diseño web para clínicas dentales<br />
              <span className="cl-hero__h1-blue">que llena agendas.</span><br />
              <span className="cl-hero__h1-outline">Tú, durmiendo.</span>
            </motion.h1>

            <motion.p variants={fadeUp} className="cl-hero__sub">
              Somos una <strong>agencia de marketing dental en Barcelona</strong> especializada en webs para dentistas.
              Aparece en el <strong>top de Google</strong>, convierte visitas en citas y añade una <strong>IA que atiende 24/7</strong> mientras tú descansas.
            </motion.p>

            <motion.div variants={fadeUp} className="cl-hero__ctas">
              <a href="#" onClick={openForm}>
                <button className="cl-btn-primary">
                  Solicitar consulta gratuita <ArrowRight size={18} />
                </button>
              </a>
              <a href="#soluciones">
        ...
        <div className="container">
          ...
          >
            ...
            <motion.h2 variants={fadeUp} className="cl-section-title">
              Sin marketing dental, tu clínica pierde<br />
      ...
      <section className="cl-video section">
        <div className="container">
          ...
          <h2 className="cl-section-title cl-section-title--light">
            Así transformamos webs de<br />
            <span className="cl-video__title-blue">clínicas dentales en España</span>
          </h2>
      ...
      <section className="cl-solutions section" id="soluciones">
        <div className="container">
          ...
          >
            ...
            <motion.h2 variants={fadeUp} className="cl-section-title">
              Servicios de marketing dental<br />
              <span className="text-primary">para clínicas en España</span>
            </motion.h2>
          ...
          <div className="cl-ai__inner">
            ...
            >
              ...
              <motion.h2 variants={fadeUp} className="cl-section-title cl-section-title--light">
                Chatbot IA para dentistas:<br />
                <span className="cl-ai__title-blue">citas automáticas 24/7</span>
              </motion.h2>
      ...
      <section className="cl-stats section" ref={statsRef}>
        <div className="container">
          ...
          <h2 className="cl-section-title cl-section-title--light">
            Resultados del marketing dental<br />
            <span className="cl-stats__title-accent">en clínicas reales</span>
          </h2>
          ...
          <div className="cl-panel__inner">
            ...
            <div className="cl-panel__copy">
              ...
              <h2 className="cl-section-title">
                Panel de control para tu web dental<br />
      ...
      <section className="cl-process section" id="proceso">
        <div className="container">
          ...
          >
            ...
            <motion.h2 variants={fadeUp} className="cl-section-title">
              Cómo creamos tu web dental<br />
              <span className="text-primary">y llenamos tu agenda</span>
            </motion.h2>
            ...
            <motion.div variants={stagger} className="cl-price__grid">
              {PRICING.map((plan, i) => (
                ...
                >
                  ...
                  <a href="#" onClick={openForm} className="cl-price-card__cta-wrap">
      ...
      <section className="cl-reviews section" id="testimonios" aria-label="Testimonios de clínicas dentales">
        <div className="container">
          ...
          >
            <motion.div variants={fadeUp} className="cl-section-label">Opiniones de clientes</motion.div>
            <motion.h2 variants={fadeUp} className="cl-section-title">
              Clínicas dentales que confían<br />
              <span className="text-primary">en nuestra agencia de marketing</span>
            </motion.h2>
        ...
        <div className="container">
          ...
          >
            ...
            <motion.h2 variants={fadeUp} className="cl-section-title">
              ...
              <span className="text-primary">marketing dental en España</span>
            </motion.h2>
        ...
        <div className="container">
          ...
          >
            ...
            <h2 className="cl-cta__title">
              ¿Listo para tener la clínica dental<br />
